...
class RBM(object):
    ...
    def __init__(self, num_visible, num_hidden, visible_unit_type='bin', main_dir='rbm', model_name='rbm_model',
        ...
        :param model_name: name of the models, used to save data
    ...
    def fit(self, train_set, validation_set=None, restore_previous_model=False):
        ...
        :param restore_previous_model:
                    if true, a previous trained models
                    with the same name of this models is restored from disk to continue training.
        :return: self
        """
    ...
    def _initialize_tf_utilities_and_ops(self, restore_previous_model):
        ...
        Restore a previously trained models if the flag restore_previous_model is true.
        """
    ...
    def _build_model(self):
        ...
        """ Build the Restricted Boltzmann Machine models in TensorFlow.
        :return: self
        """
    ...
    def _create_placeholders(self):
        ...
        """ Create the TensorFlow placeholders for the models.
    ...
    def _create_variables(self):
        ...
        """ Create the TensorFlow variables for the models.
    ...
    def load_model(self, shape, gibbs_sampling_steps, model_path):
        ...
        """ Load a trained models from disk. The shape of the models
        (num_visible, num_hidden) and the number of gibbs sampling steps
        must be known in order to restore the models.
